...
export declare namespace FormFramework {
  ...
  export interface ReactFCWithChildren
    extends React.FC<{
      children: React.ReactNode;
    }> {}
  ...
  export interface Button extends React.FC<Omit<ButtonProps, 'ref'>> {}
